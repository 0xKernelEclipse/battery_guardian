...
The current run has 124 passing unit and integration checks and a 100,000-transition charge-policy property test. The number comes from the test runner output, not a separate test matrix.
