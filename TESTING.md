...
The current run has 128 passing unit and integration checks and a 100,000-transition charge-policy property test. The test executable prints the totals at the end of each run.
